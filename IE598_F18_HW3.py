...
for i in range(numElt):
	corr23 += (dataRow[i] - mean2) * (dataRow3[i] - mean3) / (sqrt(var2*var3) * numElt)
...
#Section 2.1 + Had to rewrite using python3 urllib
...
#Calculate quartile boundaries for 4 equal
ntiles = 4
percentBdry = []
